...
<header id="header"  >
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <li><a class="nav-link scrollto " href="/profile-manager">Main</a></li>
                <li><a class="nav-link scrollto " href="/profile-manager-section-panel">Section Panel</a></li>
                <li class="dropdown"><a href="#"><span>Requests</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="/profile-manager-request-doctor"> Doctors </a></li>
                        <li><a href="/profile-manager-request-manager"> Managers </a></li>
                    </ul>
                </li>
