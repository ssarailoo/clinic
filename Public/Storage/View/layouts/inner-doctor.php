        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <?php if (Application::isAccActivated()) { ?>
                    <li class="dropdown"><a href="#"><span>Manage Panel</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="/profile-doctor-appointment">Set Appointment</a></li>
                            <li><a href="/profile-doctor-edit">Edit Your profile</a></li>
                            <li><a href="/profile-doctor">Main</a></li>
                        </ul>
                    </li>
                <?php } ?>
